...
export default function CallToAction() {
  return (
    <section className="py-20 px-2">
      <Card className="flex flex-col items-center justify-center dark:border-white/20 gap-6 rounded-2xl border border-black/20 p-12 bg-card max-w-sm md:max-w-xl lg:max-w-5xl mx-auto">
